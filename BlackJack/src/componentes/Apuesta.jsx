...
export function Apuesta({ visible, dinero, funcionSetDinero, empezarJuego }) {
    ...
    <>
      ...
      >
        <div className="ml-4 mr-4 flex flex-wrap border h-vhh fondo-gris border-gray-400 rounded-2xl w-2/3 text-white text-center justify-center">
          <div className="min-w-full h-1 mt-5 text-white font-bold text-4xl">
            Apuesta: {apuesta} 
          </div>
          ...
          <div className="min-w-full h-1 mt-5 text-white font-bold text-2xl">
            Dinero: {dinero}
          </div>
          ...
          <div className=" min-w-full h-1/3 ">
            <div className=" text-xl font-extrabold">Fichas</div>
